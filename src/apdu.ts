const SELECT_THAI_ID_CARD = Buffer.from("00A4040008A000000054480001", "hex");
...
const CMD_GET_RESPONSE = (length: number): Buffer =>
  Buffer.from(`00C00000${length.toString(16).padStart(2, "0")}`, "hex");
